...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'display_title'); ?>
		<?php echo $form->textField($model,'display_title',array('size'=>60,'maxlength'=>255)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'lookup'); ?>
		<?php echo $form->textField($model,'lookup'); ?>
	</div>
